...
impact: CRITICAL
impactDescription: Handle 10-100x more concurrent schema
...
-- Result: 500 concurrent schema = 500 connections = crashed database
...
-- Result: 500 concurrent schema share 10 actual connections
