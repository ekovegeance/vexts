...
impact: CRITICAL
impactDescription: Handle 10-100x more concurrent auth
...
-- Result: 500 concurrent auth = 500 connections = crashed database
...
-- Result: 500 concurrent auth share 10 actual connections
